...
<form:form action="updateMemberInfo.me" method="post"
	commandName="member">
	<input type="hidden" name="memberNum"
		value="<%=member.getMemberNum()%>">
	<div class="row">
	...
	<div class="row">
		<div class="col-md-5"></div>
		<div class="col-md-2">
			비밀번호 확인 <input type="password" name="passwordCheck" class="form-control">
	...
	<div class="row">
		...
		<div class="col-md-2">
			전화번호 <input type="text" name="phoneNum"
				value="<%=member.getPhoneNum()%>" class="form-control">
	...
	<div class="row">
		...
		<div class="col-md-1">
			<input type="text" id="sample6_postcode" name="address"
				placeholder="우편번호" value="<%=addr[0]%>" class="form-control">
		</div>
		<div class="col-md-1">
	...
	<div class="row">
		...
		<div class="col-md-2">
			<input type="text" id="sample6_address" name="address"
				placeholder="주소" size="40" value="<%=addr[1]%>" class="form-control">
			<input type="text" id="sample6_detailAddress" name="address"
				placeholder="상세주소" value="<%=addr[2]%>" class="form-control">
			<input type="text" id="sample6_extraAddress" name="address"
				placeholder="참고항목" value="<%=addr[3]%>" class="form-control">
